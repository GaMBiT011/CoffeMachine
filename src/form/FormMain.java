...
public class FormMain extends javax.swing.JDialog implements DocumentListener {
    ...
    private void btnMakeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMakeActionPerformed
        try {
            ...
            } catch (NotEnoughCashException ce) {
                throw ce;
            } finally {
    ...
    private void addNotes() {
        ...
        while (currentNode != null) {
            if (currentNode instanceof Node100) {
                currentNode.addNotes(10);
            }
            if (currentNode instanceof Node50) {
                currentNode.addNotes(8);
            }
            if (currentNode instanceof Node20) {
                currentNode.addNotes(5);
            }
            if (currentNode instanceof Node1) {
                currentNode.addNotes(25);
            }
            currentNode = currentNode.getNext();
        }
    }

    private void printCurrentNotesNumber() {
        Node currentNode = chain;
        while (currentNode != null) {
            System.out.println(currentNode.toString() + "BankNotes number: " + currentNode.getNotesNumber());
            currentNode = currentNode.getNext();
        }
    }
}
